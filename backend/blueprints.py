...
def registrarBlueprints(app):
    blueprints = [
       login_bp, cadastro_bp, logout_bp, reservas_bp, usuarios_bp, salas_bp, criar_manutencao_bp, criar_recursos_bp, excluir_manutencao_bp, excluir_recursos_bp, editar_recursos_bp, editar_manutencao_bp, perfil_bp, reservas_ativas_bp, historico_reservas_bp, exclusao_perfil_bp, atualizar_perfil_bp, exclusao_reserva_bp
    ]
